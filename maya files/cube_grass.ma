...
//Name: cube_grass.ma
//Last modified: Wed, Jun 09, 2010 01:53:33 PM
//Codeset: 1252
requires maya "2010";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.6983013843899348 3.9764196476376137 -8.6089644594297745 ;
	setAttr ".r" -type "double3" -21.938352729552943 -2362.9999999995362 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 10.301052890212242;
...
createNode transform -n "pCube1";
	setAttr ".s" -type "double3" 1.2444441498703458 1.2444441498703458 1.2444441498703458 ;
...
createNode polyTweakUV -n "cube_grass_polyTweakUV1";
	setAttr ".uopa" yes;
	setAttr -s 14 ".uvtk[0:13]" -type "float2" -0.37603235 -1.0065153 0.37603223 
		-1.0065153 -0.37603235 -0.25445423 0.37603223 -0.25445423 -0.37603235 0.49761063 
		0.37603223 0.49761063 -0.37603235 1.2496775 0.37603223 1.2496775 -0.37603235 2.0017436 
		0.37603223 2.0017436 1.1280968 -1.0065153 1.1280968 -0.25445423 -1.1280968 -1.0065153 
		-1.1280968 -0.25445423;
select -ne :time1;
	setAttr ".o" 1;
...
connectAttr "cube_grass_polyTweakUV1.out" "pCubeShape1.i";
connectAttr "cube_grass_polyTweakUV1.uvtk[0]" "pCubeShape1.uvst[0].uvtw";
...
connectAttr "cube_grass_file1.oc" "grassM.c";
connectAttr "grassM.oc" "cube_grass_lambert2SG.ss";
connectAttr "pCubeShape1.iog" "cube_grass_lambert2SG.dsm" -na;
connectAttr "cube_grass_lambert2SG.msg" "cube_grass_materialInfo1.sg";
connectAttr "grassM.msg" "cube_grass_materialInfo1.m";
connectAttr "cube_grass_file1.msg" "cube_grass_materialInfo1.t" -na;
...
connectAttr "polyCube1.out" "cube_grass_polyTweakUV1.ip";
...
connectAttr "grassM.msg" ":defaultShaderList1.s" -na;
