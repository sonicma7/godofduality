...
//Name: ground_sign.ma
//Last modified: Wed, Jun 09, 2010 02:03:21 PM
//Codeset: 1252
requires maya "2010";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.50784998640034673 12.27185824100372 -0.78684315543744299 ;
	setAttr ".r" -type "double3" 633.86164726998788 6.9999999999981313 -1.2016650344938564e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 9.8899877491962727;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.77084344625473022 0.10128722664329315 ;
...
createNode polyTweakUV -n "polyTweakUV2";
	setAttr ".uopa" yes;
	setAttr -s 14 ".uvtk[0:13]" -type "float2" 0.77542591 -0.59399724 0.97811335 
		-0.53379202 0.96150774 -0.48072314 0.76036835 -0.54046857 0.70784336 -0.55607039 
		0.50825268 -0.61535662 0.66565418 0.51529169 0.46451476 0.45554596 0.15909983 0.36482573 
		0.45495346 -0.63118845 0.6505965 0.56882083 0.44790915 0.50861549 0.41198972 0.43994412 
		0.21239887 0.38065749;
...
createNode polyTweakUV -n "polyTweakUV4";
	setAttr ".uopa" yes;
	setAttr -s 14 ".uvtk[0:13]" -type "float2" 0.84532839 -0.75119334 1.0327638 
		-0.69228631 1.0170336 -0.64223349 0.82959783 -0.70114058 0.77954489 -0.71687132 0.59210908 
		-0.77577734 0.70400977 0.35378191 0.5165742 0.29487497 0.2290324 0.20450789 0.54205608 
		-0.79150778 0.68827921 0.40383494 0.50084358 0.34492782 0.46652117 0.27914435 0.27908531 
		0.22023837;
...
createNode polyTweakUV -n "polyTweakUV5";
	setAttr ".uopa" yes;
	setAttr -s 14 ".uvtk[0:13]" -type "float2" 0.76909488 -0.79856741 0.57092017 
		-0.87904269 0.58922803 -0.92257547 0.78740281 -0.84210026 0.32921281 -0.9771958 0.5273875 
		-0.89672059 0.10850965 0.099295154 -0.089664936 0.018819779 0.3319093 0.24098104 
		0.13373458 0.16050586 0.15204243 0.11697312 0.35021719 0.19744831 -0.13319777 0.0011418848 
		0.28568003 -0.99487364;
...
connectAttr "file16.oc" "sign_.c";
connectAttr "sign_.oc" "lambert2SG.ss";
connectAttr "pCubeShape1.iog" "lambert2SG.dsm" -na;
connectAttr "pCubeShape2.iog" "lambert2SG.dsm" -na;
connectAttr "pCubeShape3.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "sign_.msg" "materialInfo1.m";
